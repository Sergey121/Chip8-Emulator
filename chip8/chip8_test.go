...
func TestOp2NNN_CallSubroutine(t *testing.T) {
	...
	if chip.PC != 0x20A {
		t.Errorf("Expected PC to be 0x20A, got 0x%X", chip.PC)
	}

	if chip.Stack[0] != 0x202 {
		t.Errorf("Expected Stack[0] to be 0x202, got 0x%X", chip.Stack[0])
	}

	if chip.SP != 1 {
		t.Errorf("Expected SP to be 1, got %d", chip.SP)
	}
}
...
func TestOp00EE_ReturnFromSubroutine(t *testing.T) {
	...
	if chip.PC != 0x300 {
		t.Errorf("Expected PC to return to 0x300, got 0x%X", chip.PC)
	}

	if chip.SP != 0 {
		t.Errorf("Expected SP to be 0 after return, got %d", chip.SP)
	}
}

func TestOp3XNN_SkipIfEqual(t *testing.T) {
	chip := New()
	chip.V[2] = 0xAB
	chip.Memory[0x200] = 0x32 // 0x3XNN, X=2
	chip.Memory[0x201] = 0xAB // NN=0xAB
...
func TestOp3XNN_NoSkipIfNotEqual(t *testing.T) {
	chip := New()
	chip.V[2] = 0xAA
	chip.Memory[0x200] = 0x32
	chip.Memory[0x201] = 0xAB
...
func TestOp4XNN_SkipIfNotEqual(t *testing.T) {
	chip := New()
	chip.V[2] = 0xAB
...
func TestOp4XNN_NoSkipIfEqual(t *testing.T) {
	chip := New()
	chip.V[2] = 0xCD
	chip.Memory[0x200] = 0x42
	chip.Memory[0x201] = 0xCD
...
func TestOp5XY0_SkipIfEqual(t *testing.T) {
	chip := New()
	chip.V[1] = 0x42
	chip.V[2] = 0x42
	chip.Memory[0x200] = 0x51
	chip.Memory[0x201] = 0x20 // Y = 2
...
func TestOp5XY0_NoSkipIfNotEqual(t *testing.T) {
	chip := New()
	chip.V[1] = 0x42
	chip.V[2] = 0x99
	chip.Memory[0x200] = 0x51
...
func TestOpcodeFX33(t *testing.T) {
	...
	chip.PC = 0x200
	chip.I = 0x300
	chip.V[4] = 123 // BCD: 1, 2, 3
	chip.Memory[0x200] = 0xF4
	chip.Memory[0x201] = 0x33

	chip.EmulateCycle()

	if chip.Memory[0x300] != 1 {
		t.Errorf("Expected Memory[I] to be 1, got %d", chip.Memory[0x300])
	}
	if chip.Memory[0x301] != 2 {
		t.Errorf("Expected Memory[I+1] to be 2, got %d", chip.Memory[0x301])
	}
	if chip.Memory[0x302] != 3 {
		t.Errorf("Expected Memory[I+2] to be 3, got %d", chip.Memory[0x302])
	}
...
func TestOpcodeFX55(t *testing.T) {
	...
	chip.V[1] = 20
	chip.V[2] = 30
	chip.Memory[0x200] = 0xF2
	chip.Memory[0x201] = 0x55

	chip.EmulateCycle()

	if chip.Memory[0x300] != 10 {
		t.Errorf("Expected Memory[0x300] to be 10, got %d", chip.Memory[0x300])
	}
	if chip.Memory[0x301] != 20 {
		t.Errorf("Expected Memory[0x301] to be 20, got %d", chip.Memory[0x301])
	}
	if chip.Memory[0x302] != 30 {
		t.Errorf("Expected Memory[0x302] to be 30, got %d", chip.Memory[0x302])
	}
	if chip.I != 0x300 {
		t.Errorf("Expected I to remain unchanged at 0x300, got 0x%X", chip.I)
	}
	if chip.PC != 0x202 {
		t.Errorf("Expected PC to be 0x202, got 0x%X", chip.PC)
	}
...
func TestOpcodeFX65(t *testing.T) {
	...
	chip.I = 0x300
	chip.Memory[0x300] = 5
	chip.Memory[0x301] = 10
	chip.Memory[0x302] = 15
	chip.Memory[0x200] = 0xF2
	chip.Memory[0x201] = 0x65

	chip.EmulateCycle()

	if chip.V[0] != 5 {
		t.Errorf("Expected V0 to be 5, got %d", chip.V[0])
	}
	if chip.V[1] != 10 {
		t.Errorf("Expected V1 to be 10, got %d", chip.V[1])
	}
	if chip.V[2] != 15 {
		t.Errorf("Expected V2 to be 15, got %d", chip.V[2])
	}
	if chip.I != 0x300 {
		t.Errorf("Expected I to remain unchanged at 0x300, got 0x%X", chip.I)
	}
...
func TestOpcodeEX9E_KeyPressed(t *testing.T) {
	chip := New()
	chip.PC = 0x200
	chip.V[1] = 5
	chip.Keys[5] = true
	chip.Memory[0x200] = 0xE1
	chip.Memory[0x201] = 0x9E
...
func TestOpcodeEXA1_KeyNotPressed(t *testing.T) {
	chip := New()
	chip.PC = 0x200
	chip.V[2] = 7
	chip.Keys[7] = false
	chip.Memory[0x200] = 0xE2
